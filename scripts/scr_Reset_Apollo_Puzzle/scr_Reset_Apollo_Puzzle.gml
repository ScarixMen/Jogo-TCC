function scr_Reset_Apollo_Puzzle() {
    ...
    with (obj_Beach_Puzzle_Apollo_7) { activated = false; locked = false; sprite_index = spr_Beach_Puzzle_Apollo_7_Idle; image_speed = 0; }
    with (obj_Beach_Puzzle_Apollo_8) { activated = false; locked = false; sprite_index = spr_Beach_Puzzle_Apollo_8_Idle; image_speed = 0; }
